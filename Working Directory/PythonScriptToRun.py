...
AbqFDir = r"C:\Users\rober\Documents\GitHub\Meso-scale-Cantilevers-Abaqus-Automation\Working Directory" #directory location for abaqus to use (best if local)
os.chdir(AbqFDir)
