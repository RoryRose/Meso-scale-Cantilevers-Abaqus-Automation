...
for i in range(1,NumOfTests+1):
    ...
    #create field output requests for stresses and positions on the top of the cantilever#
    #and coordinate and position of points in the free end to measure deflection angle#
    ...
    mdb.models[ModelName].FieldOutputRequest(name='free_end_coord', 
        ...
        region=regionDef, sectionPoints=DEFAULT, rebar=EXCLUDE)
    #create BCs#
    #encaster the edje of the disk, create displacment of the disk along z axis by VertDisp#
    a = mdb.models[ModelName].rootAssembly
    ...
    #create report file with the stressses, displacments and coordinates given by the field outputs#
    a = mdb.models[ModelName].rootAssembly
    session.viewports['Viewport: 1'].setValues(displayedObject=a)
